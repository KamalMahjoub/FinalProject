...
var map = new ol.Map({
    ...
    //       extent: [
    //           353337.051906614,  1725131.8432129,  
    //           442169.850314876,  1841732.69834794

    //       ]
    //     })
    // ]),
    // view: new ol.View({
    //     center: ol.proj.fromLonLat([32.05, 16.15]),
    //     zoom: 9.5
    //   })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([3495829.720916, 1753385.236804, 3624766.035648, 1873910.909250], map.getSize());
